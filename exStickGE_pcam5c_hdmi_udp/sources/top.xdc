...
set_property -dict {PACKAGE_PIN H18  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI1_LP_LANE1_N]
set_property -dict {PACKAGE_PIN H17  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI1_LP_LANE1_P]
set_property -dict {PACKAGE_PIN J21  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI1_LP_CLK_N]
set_property -dict {PACKAGE_PIN J20  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI1_LP_CLK_P]

set_property -dict {PACKAGE_PIN A20  IOSTANDARD LVDS_25 DIFF_TERM false} [get_ports MIPI2_LANE0_N]
set_property -dict {PACKAGE_PIN B20  IOSTANDARD LVDS_25 DIFF_TERM false} [get_ports MIPI2_LANE0_P]
set_property -dict {PACKAGE_PIN A19  IOSTANDARD LVDS_25 DIFF_TERM false} [get_ports MIPI2_LANE1_N]
set_property -dict {PACKAGE_PIN A18  IOSTANDARD LVDS_25 DIFF_TERM false} [get_ports MIPI2_LANE1_P]
set_property -dict {PACKAGE_PIN C19  IOSTANDARD LVDS_25 DIFF_TERM false} [get_ports MIPI2_CLK_N]
set_property -dict {PACKAGE_PIN C18  IOSTANDARD LVDS_25 DIFF_TERM false} [get_ports MIPI2_CLK_P]
...
set_property -dict {PACKAGE_PIN L20  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI2_LP_LANE0_N]
set_property -dict {PACKAGE_PIN L19  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI2_LP_LANE0_P]
set_property -dict {PACKAGE_PIN M22  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI2_LP_LANE1_N]
set_property -dict {PACKAGE_PIN N22  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI2_LP_LANE1_P]
set_property -dict {PACKAGE_PIN k19  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI2_LP_CLK_N]
set_property -dict {PACKAGE_PIN K18  IOSTANDARD HSUL_12 DIFF_TERM false} [get_ports MIPI2_LP_CLK_P]
...
#set_property -dict {PACKAGE_PIN B21  IOSTANDARD LVCMOS33} [get_ports GPIO32] #HDMI0_HPD
#set_property -dict {PACKAGE_PIN A21  IOSTANDARD LVCMOS33} [get_ports GPIO33] #HDMI0_OUT_EN
...
set_property -dict {PACKAGE_PIN B21  IOSTANDARD LVCMOS33} [get_ports HDMI0_HPD]
set_property -dict {PACKAGE_PIN A21 IOSTANDARD LVCMOS33} [get_ports HDMI0_OUT_EN]
set_property PULLUP true [get_ports HDMI0_HPD]

set_property -dict {PACKAGE_PIN Y18  IOSTANDARD TMDS_33} [get_ports HDMI1_D0_P]
set_property -dict {PACKAGE_PIN Y19  IOSTANDARD TMDS_33} [get_ports HDMI1_D0_N]
set_property -dict {PACKAGE_PIN V18  IOSTANDARD TMDS_33} [get_ports HDMI1_D1_P]
set_property -dict {PACKAGE_PIN V19  IOSTANDARD TMDS_33} [get_ports HDMI1_D1_N]
set_property -dict {PACKAGE_PIN AA19 IOSTANDARD TMDS_33} [get_ports HDMI1_D2_P]
set_property -dict {PACKAGE_PIN AB20 IOSTANDARD TMDS_33} [get_ports HDMI1_D2_N]
...
set_property -dict {PACKAGE_PIN W19  IOSTANDARD TMDS_33} [get_ports HDMI1_CLK_P]
set_property -dict {PACKAGE_PIN W20  IOSTANDARD TMDS_33} [get_ports HDMI1_CLK_N]
