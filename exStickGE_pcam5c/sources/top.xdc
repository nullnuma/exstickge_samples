...
set_property -dict {PACKAGE_PIN C15  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI1_LANE0_N]
set_property -dict {PACKAGE_PIN C14  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI1_LANE0_P]
set_property -dict {PACKAGE_PIN D15  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI1_LANE1_N]
set_property -dict {PACKAGE_PIN D14  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI1_LANE1_P]
set_property -dict {PACKAGE_PIN B18  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI1_CLK_N]
set_property -dict {PACKAGE_PIN B17  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI1_CLK_P]
...
set_property -dict {PACKAGE_PIN D20  IOSTANDARD LVCMOS33} [get_ports MIPI1_LP_LANE0_N]
set_property -dict {PACKAGE_PIN C20  IOSTANDARD LVCMOS33} [get_ports MIPI1_LP_LANE0_P]
set_property -dict {PACKAGE_PIN C22  IOSTANDARD LVCMOS33} [get_ports MIPI1_LP_LANE1_N]
set_property -dict {PACKAGE_PIN B22  IOSTANDARD LVCMOS33} [get_ports MIPI1_LP_LANE1_P]
set_property -dict {PACKAGE_PIN G17  IOSTANDARD LVCMOS33} [get_ports MIPI1_LP_CLK_N]
set_property -dict {PACKAGE_PIN G18  IOSTANDARD LVCMOS33} [get_ports MIPI1_LP_CLK_P]

set_property -dict {PACKAGE_PIN A20  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI2_LANE0_N]
set_property -dict {PACKAGE_PIN B20  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI2_LANE0_P]
set_property -dict {PACKAGE_PIN A19  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI2_LANE1_N]
set_property -dict {PACKAGE_PIN A18  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI2_LANE1_P]
set_property -dict {PACKAGE_PIN C19  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI2_CLK_N]
set_property -dict {PACKAGE_PIN C18  IOSTANDARD TMDS_33 DIFF_TERM true} [get_ports MIPI2_CLK_P]
